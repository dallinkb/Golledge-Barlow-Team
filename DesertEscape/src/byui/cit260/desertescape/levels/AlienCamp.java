...
public class AlienCamp implements Serializable {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 53 * hash + Objects.hashCode(this.run);
        hash = 53 * hash + Objects.hashCode(this.inspect);
        hash = 53 * hash + Objects.hashCode(this.pause);
        return hash;
    }
    ...
    public String toString() {
        return "AlienCamp{" + "run=" + run + ", inspect=" + inspect + ", pause=" + pause + '}';
    }
